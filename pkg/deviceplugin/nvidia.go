...
//		log.Infof("single gpu mem: %d, going to split each gpu to %d totalShares", m.Devices[0].Memory.Total, metaGpus)
...
func NewNvidiaDeviceManager() *NvidiaDeviceManager {
	...
	// if autoReshare is true, try to calculate automatically amount of totalShares
